...
public class EmailSenderCancelling {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new EmailSenderCancelling("has@gmail.com", "101", "Deluxe Room", "150", "19/9/2023");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public EmailSenderCancelling(String uemail, String roomNumber, String roomType, String price, String bookingDate){
